			...
			if(Player1Calibrated)
			{
				...
				foreach(KinectGestures.GestureData gestureData in player1Gestures)
				{
					if(gestureData.complete)
					{
                        ...
                        if (gestureData.gesture == KinectGestures.Gestures.Pull)
                        {
                            stick.MoveBack();
                        }
					...
					else if(gestureData.progress >= 0.1f)
					{
                        ...
                        //if (gestureData.gesture == KinectGestures.Gestures.Wheel && gestureData.progress > 0.5f)
                        //{
                        //    string sGestureText = string.Format("{0} detected, angle={1:F1} deg", gestureData.gesture, gestureData.screenPos.z);
                        //    wheel.SetRotation(gestureData.screenPos.z);
